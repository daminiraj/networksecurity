...
class DataTransformation:
    ...
    def get_transformer_object(cls) ->Pipeline:
        logging.info("eneter get_data_transform_object of transformation class")
        try:
    ...
    def initiate_data_transformation(self):
        logging.info("initiakisng data transformation pipeline")
        try:
            ...
            save_obj("final_model/preprocessor.pkl",preprocessor)
