...
async def predict_route(request: Request, file: UploadFile = File(...)):
    try:
        ...
        # print(df)
        preprocesor = load_obj("C:\\Users\\Damini.gupta\\PycharmProjects\\Networksecurity\\final_model\\preprocessor.pkl")
        final_model = load_obj("C:\\Users\\Damini.gupta\\PycharmProjects\\Networksecurity\\final_model\\model.pkl")
